...
import (
	...
	"github.com/30x/shipyard/pkg/server/restapi"
...
func main() {
	...
	api := operations.NewApisForBuildingDockerImagesAPI(swaggerSpec)
	server := restapi.NewServer(api)
	defer server.Shutdown()

	parser := flags.NewParser(server, flags.Default)
	parser.ShortDescription = `APIs for building docker images.`
